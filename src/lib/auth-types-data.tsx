...
import { 
    ...
    OidcSetup,
    SamlSetup,
    CertificateAuthSetup,
    MfaSetup
} from '@/components/auth/AuthTypeSetups';
...

{
  ...
  },
  {
    ...
    setupInstructions: SessionAuthSetup,
    diagram: GenericAuthDiagram,
...
X-API-Key: a1b2c3d4-e5f6-7890-a1b2-c3d4e5f67890`
  ...
  },
  {
    ...
    setupInstructions: CertificateAuthSetup,
    diagram: GenericAuthDiagram,
      ...
      successResponse: `Decoded ID Token Payload:
{
  ...
  },
  {
    ...
    setupInstructions: HmacAuthSetup,
    diagram: GenericAuthDiagram,
...
{"event": "new_commit"}`
  ...
  },
  {
    ...
    setupInstructions: LdapAuthSetup,
    diagram: GenericAuthDiagram,
  ...
  },
  {
    ...
    setupInstructions: OtpAuthSetup,
    diagram: GenericAuthDiagram,
