...
export const SessionBasedSetup = () => (
  <ol className="list-decimal space-y-2 pl-5">
...
export const CertificateBasedSetup = () => (
  <ol className="list-decimal space-y-2 pl-5">
...
export const ChallengeResponseSetup = () => (
  <ol className="list-decimal space-y-2 pl-5">
...
export const DelegatedAuthSetup = () => (
  <ol className="list-decimal space-y-2 pl-5">
